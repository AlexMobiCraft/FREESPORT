...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --skip-images     Пропустить импорт изображений"
...
echo ""
echo "============================================================"
log_info "ШАГ 1/3: Импорт атрибутов товаров..."
echo "============================================================"
...
echo ""
echo "============================================================"
log_info "ШАГ 2/3: Импорт каталога товаров..."
echo "============================================================"
