...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if self.use_mock_data:
                ...
                self.stdout.write(f"📦 Загружены тестовые данные: {len(products_data)} товаров")
            else:
        ...
        for i in range(1, 21):  # 20 тестовых товаров
            product = {
                ...
                'prices': {
                    ...
                    'recommended_retail_price': str(Decimal('1200.00') + Decimal(i * 120)),
                    'max_suggested_retail_price': str(Decimal('1500.00') + Decimal(i * 150)),
                },
    ...
    def _process_single_product(self, product_data: Dict):
        ...
        for price_field in ['retail_price', 'opt1_price', 'opt2_price', 'opt3_price',
