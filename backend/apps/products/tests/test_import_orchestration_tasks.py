...
class TestImportOrchestrationTasks:
    ...
    def test_process_1c_import_task_with_zip_unpacking(self, mock_file_service_cls, mock_call_command):
        ...
        # Actually patch('apps.integrations.onec_exchange.file_service.FileStreamService') patches the class where it's defined.
        # When tasks.py does `from apps.integrations.onec_exchange.file_service import FileStreamService`, it gets the Mock.
        # Valid.
