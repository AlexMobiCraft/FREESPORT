...
class TestOrderHistoryAPI:
    ...
    def test_order_history_sorting(self, user_factory, order_factory):
        ...
        order1 = order_factory.create(user=user, order_number="FIRST")
        order2 = order_factory.create(user=user, order_number="SECOND")
        order3 = order_factory.create(user=user, order_number="THIRD")
