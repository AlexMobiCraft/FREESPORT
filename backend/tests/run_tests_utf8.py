...
def run_unit_tests():
    ...
    test_commands = [
        ...
        [
            ...
            "manage.py",
            "test",
            "apps.cart.tests.CartAPITestCase",
            "--verbosity=2",
        ],
        ...
        [
            ...
            "manage.py",
            "test",
            "apps.cart.tests.CartIntegrationTestCase",
            "--verbosity=2",
        ],
        # Users API тесты
    ...
    for i, command in enumerate(test_commands, 1):
        ...
        test_type = (
            "ALL" if len(command[3].split(".")) == 2 else command[3].split(".")[2]
        )
...
def main():
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "--functional":
            ...
            print("Использование:")
            print(
                "  python run_tests_utf8.py --functional  # Функциональные тесты HTTP API"
            )
