...
class TestLoadTestCatalogCommand:
    ...
    def test_command_clear_existing_data(self):
        ...
        Brand.objects.create(name='Тестовый бренд OLD')
        Category.objects.create(name='Тестовая категория OLD')
    ...
    def test_command_with_existing_brands_categories(self):
        ...
        existing_category = Category.objects.create(name='Существующая категория', is_active=True)
