...
class CatalogPerformanceTest(TestCase):
    ...
    def test_catalog_list_performance(self):
        ...
        self.assertLess(response_time, 1.0, f"Catalog response time {response_time:.2f}s exceeds 1s limit")
    ...
    def test_catalog_with_filters_performance(self):
        ...
        self.assertLess(response_time, 1.5, f"Filtered catalog response time {response_time:.2f}s exceeds 1.5s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_product_detail_performance(self):
        ...
        self.assertLess(response_time, 0.5, f"Product detail response time {response_time:.2f}s exceeds 0.5s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_categories_tree_performance(self):
        ...
        self.assertLess(response_time, 0.3, f"Categories tree response time {response_time:.2f}s exceeds 0.3s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_brands_list_performance(self):
        ...
        self.assertLess(response_time, 0.2, f"Brands list response time {response_time:.2f}s exceeds 0.2s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_catalog_pagination_performance(self):
        ...
        self.assertLess(response_time, 1.0, f"Pagination response time {response_time:.2f}s exceeds 1s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_role_based_pricing_performance(self):
        ...
        self.assertLess(response_time, 1.2, f"Role-based pricing response time {response_time:.2f}s exceeds 1.2s limit")
        self.assertEqual(response.status_code, 200)
    ...
    def test_catalog_stress_test(self):
        ...
        self.assertLess(avg_response_time, 1.0, f"Average response time {avg_response_time:.2f}s exceeds 1s")
        self.assertLess(max_response_time, 2.0, f"Max response time {max_response_time:.2f}s exceeds 2s")
