...
This project is indexed by GitNexus as **FREESPORT** (8433 symbols, 13720 relationships, 296 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
