...
This project is indexed by GitNexus as **FREESPORT** (9565 symbols, 15734 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
