...
This project is indexed by GitNexus as **FREESPORT** (8512 symbols, 13948 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
