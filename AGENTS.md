...
This project is indexed by GitNexus as **FREESPORT** (8847 symbols, 14129 relationships, 292 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
