...
This project is indexed by GitNexus as **FREESPORT** (8911 symbols, 14211 relationships, 295 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
