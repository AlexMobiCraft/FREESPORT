...
This project is indexed by GitNexus as **FREESPORT** (8332 symbols, 13618 relationships, 296 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
