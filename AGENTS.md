...
This project is indexed by GitNexus as **FREESPORT** (9615 symbols, 15821 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
