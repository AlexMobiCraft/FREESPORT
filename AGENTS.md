...
This project is indexed by GitNexus as **FREESPORT** (8998 symbols, 14767 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
