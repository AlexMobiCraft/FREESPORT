...
This project is indexed by GitNexus as **FREESPORT** (8934 symbols, 14653 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
