...
This project is indexed by GitNexus as **FREESPORT** (8490 symbols, 13909 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
