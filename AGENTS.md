...
This project is indexed by GitNexus as **FREESPORT** (9354 symbols, 15343 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
