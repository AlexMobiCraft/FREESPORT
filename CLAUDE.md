...
This project is indexed by GitNexus as **FREESPORT** (8491 symbols, 13898 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
