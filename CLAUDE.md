...
This project is indexed by GitNexus as **FREESPORT** (8504 symbols, 13921 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
