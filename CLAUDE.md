...
This project is indexed by GitNexus as **FREESPORT** (9656 symbols, 15912 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
