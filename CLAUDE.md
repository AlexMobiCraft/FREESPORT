...
This project is indexed by GitNexus as **FREESPORT** (9363 symbols, 15361 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
