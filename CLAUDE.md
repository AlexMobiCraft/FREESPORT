...
This project is indexed by GitNexus as **FREESPORT** (8481 symbols, 13880 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
