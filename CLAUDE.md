...
This project is indexed by GitNexus as **FREESPORT** (8353 symbols, 13648 relationships, 297 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
