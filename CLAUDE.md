...
This project is indexed by GitNexus as **FREESPORT** (9045 symbols, 14835 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
