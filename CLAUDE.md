...
This project is indexed by GitNexus as **FREESPORT** (9824 symbols, 16212 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
