...
This project is indexed by GitNexus as **FREESPORT** (8942 symbols, 14664 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
