...
- E09 — бренд id=37 + `Brand1CMapping`. Проверка после правки: `GET /api/v1/brands/` + карточки товаров бренда; маппинг — перед следующим импортом 1С.
- E11 — excerpt статьи. Проверка после правки: `GET /api/v1/blog/` + страница статьи после ревалидации.
