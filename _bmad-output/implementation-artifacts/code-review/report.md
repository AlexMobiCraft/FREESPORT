...
- **Process Deadlock (Deferred Scope):** The story is stuck in a review loop due to DEFERRED E2E tests (AC2/AC3). Since this scope is formally moved to "Epic 32 E2E story", keeping this story in "Changes Requested" is incorrect. It should be evaluated against its _remaining_ scope.
