...
| 2026-04-19 | Addressed code review findings batch 3 — 2 items resolved (Patch×2): AC5 — item-level НДС строго через item.vat*rate→variant.vat_rate→order_vat_rate без warehouse; AC8 — vat_group=None→DEFAULT*\* напрямую + warning. 2 новых unit-теста, 2 legacy теста обновлены. Полный прогон: 105/105 зелёные. Статус: review.                                                                                                                                                                           |
