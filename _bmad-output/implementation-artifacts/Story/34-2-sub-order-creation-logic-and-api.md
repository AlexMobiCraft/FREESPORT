...
**Twenty-Eighth Follow-up (2026-04-18) — подтверждённые результаты:**

Backend regression (pytest, orders area):
```
111 passed, 6 warnings in 179.62s
```
Backend flake8: чистый (нет ошибок) для всех изменённых файлов.
