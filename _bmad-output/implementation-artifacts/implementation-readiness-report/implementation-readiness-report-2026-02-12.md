...
_Note: The `refined-prd.md` is a high-level roadmap document. It lists completed functionality (Epics 1-31) and general status. It does **not** contain specific Functional Requirements for the new "Marketing Banners" feature (Epic 32). The requirements for Epic 32 were likely derived from a specific "Story" input or interactive elicitation._
