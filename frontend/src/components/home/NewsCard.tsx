...
export const NewsCard: React.FC<NewsCardProps> = ({ title, excerpt, image, publishedAt }) => {
  ...
  return (
    <article className="group block rounded-xl overflow-hidden bg-white shadow-default hover:shadow-hover transition-shadow focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2">
