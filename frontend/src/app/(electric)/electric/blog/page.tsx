                    ...
                    {hasPosts ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            <div className="w-16 h-16 rounded-none bg-[var(--bg-card)] flex items-center justify-center mb-4 transform -skew-x-12 border border-[var(--border-default)]">
                                <BookOpen className="w-8 h-8 text-[var(--color-primary)] transform skew-x-12" aria-hidden="true" />
                            </div>
                            <h3 className="text-xl font-bold text-[var(--foreground)] mb-2 uppercase">Статей пока нет</h3>
