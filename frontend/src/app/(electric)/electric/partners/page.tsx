        ...
        <div className="min-h-screen bg-[var(--bg-body)]">
            <div className="container mx-auto px-4 py-8">
                ...
                <section className="mb-12 text-center bg-[var(--bg-card)] py-12 border border-[var(--border-default)]">
                    ...
                    <p className="text-lg text-[var(--color-text-secondary)]">Выстраиваем долгосрочные партнёрские отношения</p>
                </section>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {clientTypes.map((type, index) => (
                            <div key={index} className="bg-[var(--bg-card)] p-6 border border-[var(--border-default)] hover:border-[var(--color-primary)] transition-colors group">
                                ...
                                <h3 className="text-xl font-bold text-[var(--foreground)] mb-2 uppercase">{type.title}</h3>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {processSteps.map((step) => (
                            <div key={step.number} className="relative bg-[var(--bg-card)] p-6 border border-[var(--border-default)]">
                                ...
                                <h3 className="mt-4 text-xl font-bold text-[var(--foreground)] mb-2 uppercase">{step.title}</h3>
                ...
                <section className="mb-16">
                    <div className="bg-[var(--bg-card)] p-8 border border-[var(--border-default)] flex items-start gap-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-[var(--foreground)] mb-3 uppercase">Персональный менеджер</h3>
                            <p className="text-[var(--color-text-secondary)] leading-relaxed">
                                На всех этапах сотрудничества с вами работает персональный менеджер. Он поможет подобрать товар, оформить заказ, проконсультирует по всем вопросам и обеспечит своевременную доставку.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-16">
                    ...
                    <div className="mx-auto max-w-3xl space-y-4">
                        {faqItems.map((item, i) => (
                            <details key={i} className="bg-[var(--bg-card)] border border-[var(--border-default)] group">
