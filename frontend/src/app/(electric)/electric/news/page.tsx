                    ...
                    {hasNews ? (
                                    ...
                                    <div className="flex gap-2">
                                        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                                            <Link
                                                ...
                                                className={`px-4 py-2 rounded-none transform -skew-x-12 transition-colors ${page === currentPage
                        ...
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            <div className="w-16 h-16 rounded-none bg-[var(--bg-card)] flex items-center justify-center mb-4 transform -skew-x-12 border border-[var(--border-default)]">
                                <Newspaper className="w-8 h-8 text-[var(--color-primary)] transform skew-x-12" aria-hidden="true" />
                            </div>
                            <h3 className="text-xl font-bold text-[var(--foreground)] mb-2 uppercase">Новостей пока нет</h3>
