...
const requisites: ReadonlyArray<{ label: string; value: string }> = [
  ...
  { label: 'ОГРН', value: '1197847087239' },
  {
    ...
    value:
      '196006, Санкт-Петербург г, Ломаная ул, дом 11, литер А, помещение 16-Н, комната 5',
  },
  {
    ...
    <div className="min-h-screen bg-canvas">
      ...
      <section className="bg-panel py-8 sm:py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-headline-l sm:text-display-m text-text-primary">
            Реквизиты
          </h1>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-8 sm:py-12">
        <Card className="p-6 sm:p-8">
          <h2 className="text-title-l text-text-primary mb-6 sm:mb-8">
            {companyName}
          </h2>
          ...
          <dl className="divide-y divide-neutral-300">
            {requisites.map(({ label, value }) => (
              ...
              >
                ...
                <dd className="text-body-m text-text-primary font-semibold">
                  {value}
                </dd>
              </div>
            ))}
