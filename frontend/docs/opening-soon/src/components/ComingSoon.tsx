...
import backgroundImage from 'figma:asset/c2a0015a6d9524229752c5443f67693f9091a156.png';
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-5xl md:text-7xl text-white mb-2 tracking-tight">
          ...
          >
            <h2 className="text-3xl md:text-4xl text-gray-900 mb-4">МЫ СКОРО ВЕРНЕМСЯ</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="flex flex-col items-center p-4">
                ...
                <h3 className="text-gray-900 mb-1">B2C Магазин</h3>
              ...
              <div className="flex flex-col items-center p-4">
                ...
                <h3 className="text-gray-900 mb-1">B2B Решения</h3>
              ...
              <div className="flex flex-col items-center p-4">
                ...
                <h3 className="text-gray-900 mb-1">Лучшие цены</h3>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600">РАЗРАБОТКА ИДЕТ ПО ПЛАНУ!</span>
                <span className="text-sm text-orange-500">{progress}%</span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <p className="text-gray-700 mb-4">Узнайте первым о нашем запуске</p>
          ...
          >
            <p>© 2024 FREESPORT.RU — Все права защищены</p>
