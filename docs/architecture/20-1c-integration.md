...
На основе архитектурного ревью были приняты следующие дополнительные принципы:
  ...
  1. **Использование "Сессий импорта"**:
      ...
      - **Задача:** Гарантировать атомарность и целостность данных при массовом импорте из XML-файлов.
...
На основе анализа (`docs/epic-3-data-analysis.md`) определены следующие форматы и структура данных.
...
На основе анализа (`docs/epic-3-data-analysis.md`) определены следующие схемы маппинга.
