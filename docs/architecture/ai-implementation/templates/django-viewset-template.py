...
# ===== ОСНОВНОЙ VIEWSET =====
class YourModelViewSet(viewsets.ModelViewSet):  # TODO: Измените на ReadOnlyModelViewSet если только чтение
    """
    ...
    @extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter("is_active", OpenApiTypes.BOOL, description="Только активные объекты"),
            OpenApiParameter("ordering", OpenApiTypes.STR, description="Сортировка: name, -name, created_at, -created_at"),
