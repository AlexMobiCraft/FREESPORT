...
- [ ] Дизайн опций согласно дизайн-системе
  - [ ] Chip для размеров: radius 16px, border 1px #D0D7E6
  - [ ] Selected state: background #0060FF, text #FFFFFF
...
- **Chip:** используется для отображения опций
  - Default: background #FFFFFF, border 1px #D0D7E6
  - Selected: background #0060FF, text #FFFFFF
