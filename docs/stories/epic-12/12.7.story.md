...
**Созданные файлы:**
- [frontend/src/__mocks__/categories.ts](frontend/src/__mocks__/categories.ts)
- [frontend/src/__mocks__/products.ts](frontend/src/__mocks__/products.ts)
- [frontend/src/__mocks__/blogPosts.ts](frontend/src/__mocks__/blogPosts.ts)
...
- [frontend/src/components/home/__tests__/HeroSection.test.tsx](frontend/src/components/home/__tests__/HeroSection.test.tsx)
...
- **Project Structure:** ✓ Компоненты в правильных директориях (home/, layout/, __mocks__/)
