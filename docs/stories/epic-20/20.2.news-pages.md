...
- [ ] Убедиться что Story 20.1 завершена
- [ ] Расширить `newsService.ts` (Task 1)
- [ ] Создать `/news/page.tsx` (Task 2)
- [ ] Создать `/news/[slug]/page.tsx` (Task 3)
- [ ] Написать тесты (Task 4)
- [ ] Верифицировать интеграцию (Task 5)
