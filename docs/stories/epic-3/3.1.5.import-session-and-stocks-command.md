...
- [ ] Документация (`docs/epics/epic-3/data-analysis.md`, `docs/architecture/10-testing-strategy.md`) обновлена с учётом новой команды.
...
Тестирование команды `load_product_stocks` следует стратегии, описанной в [`docs/architecture/10-testing-strategy.md`](docs/architecture/10-testing-strategy.md):
...
- **Depends on:**
  - Story 3.1.1 (модель `ImportSession`, класс `XMLDataParser` с методом `parse_rests_xml()`) - [`docs/stories/epic-3/3.1.1.import-products-structure.md`](docs/stories/epic-3/3.1.1.import-products-structure.md)
  - Story 3.1.2 (import infrastructure) - [`docs/stories/epic-3/3.1.2.loading-scripts.md`](docs/stories/epic-3/3.1.2.loading-scripts.md)
- **Blocks:** -
