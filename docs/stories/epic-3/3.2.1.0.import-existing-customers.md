...
8. `backend/apps/users/migrations/0008_update_user_email_blank.py` - User.email blank=True
9. `backend/apps/users/migrations/0009_update_user_email_nullable.py` - User.email null=True
10. `backend/apps/common/migrations/0004_add_customer_sync_log.py` - CustomerSyncLog модель
