...
- [ ] **Task 5: Unit-тесты для проверки окружения** (AC: 1, 2, 3)
  - [ ] Создать тест для проверки ESLint конфигурации
  - [ ] Создать тест для проверки Prettier конфигурации
...
**Тесты для этой истории:**
- Проверка ESLint конфигурации (наличие плагинов)
- Проверка Prettier конфигурации (форматирование)
- Smoke test для Docker окружения (доступность на порту 3000)
