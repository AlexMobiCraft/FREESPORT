...
- [ ] **Task 1: Настроить Environment Variables** (AC: 2)
...
- [ ] **Task 2: Настроить Zustand stores** (AC: 1, 9)
...
- [ ] **Task 3: Создать централизованный axios клиент** (AC: 2, 3, 7, 8)
...
- [ ] **Task 4: Сгенерировать TypeScript типы из api-spec.yaml** (AC: 4)
...
- [ ] **Task 5: Реализовать authService** (AC: 5, 6, 9)
...
- [ ] **Task 6: Реализовать productsService** (AC: 5, 6)
...
- [ ] **Task 9: Реализовать ordersService** (AC: 5, 6)
...
- [ ] **Task 10: Настроить MSW для тестирования** (AC: 6)
...
- [ ] **Task 11: Проверить покрытие тестами** (AC: 6, 8)
