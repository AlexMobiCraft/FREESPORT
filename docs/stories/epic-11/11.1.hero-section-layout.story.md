...
- [ ] **Task 1: Создать базовую структуру главной страницы** (AC: 1, 4, 6)
  - [ ] Рефакторировать файл `src/app/page.tsx` - заменить статическую hero-секцию на HeroSection компонент
  - [ ] Настроить export metadata для SEO (title, description, OG tags)
  - [ ] Подготовить OG image `/public/og-image.jpg` (1200x630px) с логотипом FREESPORT
