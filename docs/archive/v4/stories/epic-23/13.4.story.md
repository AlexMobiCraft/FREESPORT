...
- **Processor:** [backend/apps/products/services/processor.py#**init**](../../backend/apps/products/services/processor.py#__init__) — инициализация stats с brand_fallbacks (строки 54-72)
