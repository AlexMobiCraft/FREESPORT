...
2. **Django Admin:**
   - Настроены фильтры по operation_type, status, created_at, customer\_\_role
...
- ✅ Then: Видит список логов с фильтрами по operation_type, status, created_at, customer\_\_role
