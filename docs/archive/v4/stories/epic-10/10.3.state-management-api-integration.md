...
5. ✅ MSW configured for API mocking in tests
6. ✅ Unit tests written for stores (9/9 passing)
...
- frontend/src/stores/**tests**/cartStore.test.ts
...
| 6   | Unit-тесты 80%+          | stores/**tests**/                               | 9/9 stores, 0/X services | ⚠️ PARTIAL  |
