...
- ESLint и Prettier конфигурации соответствуют требованиям истории: плагины react-hooks/jsx-a11y подключены, стиль форматирования закреплен тестами и lint-staged конфигурацией (@frontend/eslint.config.mjs#1-33, @frontend/.prettierrc#1-8, @frontend/src/**tests**/eslint.config.test.ts#6-70, @frontend/src/**tests**/prettier.config.test.ts#6-82).
