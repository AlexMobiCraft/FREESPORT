...
**Integration Requirements:** 5. Existing Swagger UI показывает все documented endpoints 6. New documentation следует existing @extend_schema pattern из common/views.py  
7. Integration с drf-spectacular settings maintains current behavior

**Quality Requirements:** 8. Каждый endpoint содержит описание, примеры запросов и responses 9. Authentication requirements документированы для каждого endpoint 10. Query parameters и request body схемы описаны полностью
