# Sprint Change Proposal: Миграция на сине-голубую цветовую схему
...
Предлагается системная миграция визуальной идентичности платформы FREESPORT с текущей **графитово-серой** цветовой палитры на современную **сине-голубую** схему в стиле OZON/Wildberries. Изменение затрагивает дизайн-систему, UI компоненты и документацию, но **НЕ влияет на функциональность** и бизнес-логику проекта.

**Ключевые цифры:**

- 📄 **Документов к обновлению:** 8
- 🎨 **Компонентов UI к рефакторингу:** 13
- 📋 **Stories требующих обновления:** 3
- ⏱️ **Оценка трудозатрат:** 5-7 рабочих дней
- 🎯 **Приоритет:** Medium (визуальное улучшение без блокировки функционала)

---

## 1. Анализ изменения

### 1.1 Триггер изменения

**Источник:** Стратегическое решение по брендингу
**Документ:** [color-scheme-migration.md](frontend/color-scheme-migration.md)
**Тип изменения:** Визуальное обновление дизайн-системы

**Причины миграции:**

1. Создание более современного и технологичного визуального стиля
2. Улучшение визуальной иерархии через контрастные акцентные цвета
3. Повышение конверсии CTA-элементов за счёт ярких кнопок
4. Соответствие трендам крупных e-commerce платформ (OZON, Wildberries)
5. Сохранение доступности WCAG AA стандарта

### 1.2 Суть изменения

**Текущая палитра (Графитовая):**
...
- Старые Tailwind классы (`bg-gray-*`) продолжат работать
- Большинство изменений применится автоматически через обновление CSS-переменных
- Компоненты с хардкод цветами требуют ручного рефакторинга

### 1.3 Доказательства необходимости

**Бизнес-выгоды:**

- 📈 Повышение узнаваемости бренда через яркую палитру
- 🎯 Улучшение конверсии CTA на 10-15% (по данным A/B тестов индустрии)
- 💼 Соответствие ожиданиям B2B/B2C клиентов от современного e-commerce

**Технические преимущества:**

- ✅ Контрастность WCAG AA сохранена (проверено в миграционном документе)
- ✅ Улучшенная визуальная иерархия через семантические цвета
- ✅ Упрощение поддержки благодаря токенизированной дизайн-системе

---

## 2. Влияние на структуру проекта
...
**Влияние:** ⚠️ **СРЕДНЕЕ** - Требует обновления

**Завершённые stories:**

- ✅ Story 11.0: Product badge flags - **требует обновления цветов бейджей**
- ✅ Story 11.1: Hero Section Layout - **требует обновления CTA кнопок**

**Текущие stories:**

- 🔄 Story 11.2: Dynamic content blocks - **требует обновления Badge компонента**
- 📋 Story 11.3: Subscribe form - **требует обновления input focus states**

**Действия:**

1. Обновить цвета бейджей в Story 11.0 (sale, promo, new, hit, premium)
2. Обновить CTA кнопки в Hero Section (Story 11.1)
3. Синхронизировать изменения с текущей разработкой Story 11.2
4. Обновить документацию stories с новыми цветовыми токенами

#### Epic 4: B2B Interface Development

**Статус:** ✅ Завершён
**Влияние:** 🟡 **НИЗКОЕ** - Обратно совместимо

Большинство компонентов использует CSS-переменные → автоматическое применение новой палитры.

**Исключения (требуют ручного обновления):**

- Button component (хардкод primary bg)
- Checkbox/Toggle (border colors)
- Pagination (active page bg)

#### Epic 7: B2C Interface Development

**Статус:** 📋 Запланирован
**Влияние:** ✅ **ОТСУТСТВУЕТ**

Epic ещё не начат → новые компоненты сразу используют обновлённую палитру.

### 2.2 Влияние на будущие Epic

**Epic 12+:** Все будущие Epic автоматически используют новую палитру через обновлённые токены в `design-system.json` и `globals.css`.

---

## 3. Конфликты с артефактами проекта

### 3.1 PRD (Product Requirements Document)

**Файл:** [docs/PRD.md](../PRD.md)

**Конфликты:** ❌ **ОТСУТСТВУЮТ**

**Обоснование:**

- PRD определяет **функциональные требования**, а не визуальный стиль
- FR15 "Единая дизайн-система" остаётся актуальным
- Миграция **усиливает** FR15 через улучшенную цветовую систему

**Требуемые изменения:** Нет

---

### 3.2 Архитектурная документация

**Файл:** [docs/architecture.md](../architecture.md)

**Конфликты:** ❌ **ОТСУТСТВУЮТ**

**Обоснование:**

- Архитектура описывает **техническую структуру**, не визуальный дизайн
- Не упоминаются конкретные цвета или палитры
- Принципы "API-First" и "Monorepo" не затронуты
...
**Файл:** [docs/front-end-spec.md](../front-end-spec.md)

**Конфликты:** ⚠️ **КРИТИЧЕСКИЕ** - Требует полного обновления

**Раздел 1: Дизайн-принципы**

- **Текущий:** "Единая визуальная иерархия: глубокие графитовые акценты"
- **Новый:** "Единая визуальная иерархия: яркие синие акценты и голубые вторичные тона"
