...
Сайт уезжает на собственный сервер `5.35.124.149`, хостинг reg.ru ему больше не нужен.
Если оставить хостинговые NS, зона перестанет обслуживаться, когда услуга хостинга
закончится, — и сайт ляжет без видимой причины.
