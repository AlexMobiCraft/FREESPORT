...
### Этап 1: CSS Variables Foundation

**Срок: 1 день**

1. Создать новый файл `globals-electric-orange.css`
2. Определить все CSS-переменные Electric Orange
3. Настроить Tailwind config для новой палитры
4. Создать feature flag для переключения тем
